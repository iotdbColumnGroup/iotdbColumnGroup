...
class deleteTimeseries_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i561 in range(_size557):
                        _elem562 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.path.append(_elem562)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.path is not None:
            ...
            for iter563 in self.path:
                oprot.writeString(iter563.encode('utf-8') if sys.version_info[0] == 2 else iter563)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class deleteStorageGroups_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i568 in range(_size564):
                        ...
                        self.storageGroup.append(_elem569)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.storageGroup is not None:
            ...
            for iter570 in self.storageGroup:
